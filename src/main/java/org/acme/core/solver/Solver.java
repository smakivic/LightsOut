...
import org.acme.core.solver.solution.Solutions;
...
public class Solver {
    ...
    public Solutions solve(int maxSolutions) {
        long startTime = System.currentTimeMillis(); //start time of the algorithm
        int rows = this.startGrid.rows();
        int cols = this.startGrid.columns();
        ...
        long endTime = System.currentTimeMillis(); //end time of the algorithm
        long elapsedTime = endTime - startTime; //total time of the algorithm
        System.out.println("Time taken to find the solution: " + elapsedTime + " milliseconds\n");
//        number of steps to find the solution
        System.out.println("Number of steps to find the solution: " + solutions.getComputedSolutions().iterator().next().size() + "\n");
        return solutions;
    }
